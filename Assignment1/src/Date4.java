...
public class Date4 {
  ...
  public Date4(int monthInt, int day, int year) {
    setDate(monthInt, day, year);
  }

  public Date4(String monthString, int day, int year) {
    setDate(monthString, day, year);
  }

  public Date4(int year) {
    setDate(1, 1, year);
  }

  public Date4(Date4 aDate) {
  ...
  public boolean equals(Date4 otherDate) {
    return ((month.equals(otherDate.month)) && (day == otherDate.day) && (year == otherDate.year));
  }

  public boolean precedes(Date4 otherDate) {
